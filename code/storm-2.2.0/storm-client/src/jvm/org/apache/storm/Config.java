...
public class Config extends HashMap<String, Object> {
    ...
    /** 
     * Start of Energy Aware Strategy needed profile parameters.
     */
    @IsPositiveNumber
    public static final String SUPERVISOR_CORES = "supervisor.cores";
    @IsPositiveNumber
    public static final String SUPERVISOR_CLOCK = "supervisor.clock";
    @IsPositiveNumber
    public static final String SUPERVISOR_POWER_IDLE = "supervisor.power.idle";
    @IsPositiveNumber
    public static final String SUPERVISOR_POWER_MAX = "supervisor.power.max";

    /** 
     * End of Energy Aware Strategy needed profile paramters.
     */
